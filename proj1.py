...
if _name_ == "_main_":
    ...
    parser.add_argument('model', type=str,
                        help='Model elipsoidy odniesienia. obslugiwane modele: grs80/wgs84/krasowski',
                        choices=['grs80', 'wgs84', 'krasowski'])
    parser.add_argument('fun', type=str, help='Nazwa wykonywanej funkcji',
                        choices=['flh2xyz', 'xyz2flh', 'pl2000', 'pl1992', 'neu'])
    parser.add_argument('plik', type=str, help='Nazwa pliku ze współrzędnymi.')
